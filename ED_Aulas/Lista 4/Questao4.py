...
class Arvore_binaria:
    ...
    def adicionar(self, dado):
        ...
        while True:
            if dado > current_node.dado:
                ...
                current_node.repetidos += 1
                print(f"{current_node.dado} aparece {current_node.repetidos} vezes")
                break
    ...
    def remover(self, dado):
        if dado == self.raiz.dado:
            if self.raiz.repetidos > 1:
                self.raiz.repetidos -= 1
                print(f"{self.raiz.dado} aparece {self.raiz.repetidos} vezes")
                return
            else:
